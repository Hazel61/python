...
def is_underage():
    ...
    user_age = int(input("Please give me your age as an integer. "))
    #TODO:
...
def guessing_game(num):
    ...
    print("I'm thinking of a number. You have ten chances to guess it.")
    guessed = False
    quitter = False
    for x in range(10):
        if guessed == False and quitter == False:
